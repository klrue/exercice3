...
function theme_4w4_scripts() {
	wp_register_style( 'theme-4w4-style', get_stylesheet_uri(), array(), filemtime(get_template_directory() . "/style.css") );
...
/*adaptation de la requête par défaut quand on accède à la page d'accueil
*/
